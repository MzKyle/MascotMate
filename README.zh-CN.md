...
这是一个本地运行的 Godot 桌面宠物：透明窗口动画、物理互动、陪伴行为、小游戏、截图贴图，以及浏览器版 Shimeji-ee 皮肤商店和辅助导入。
...
- 可以在浏览器皮肤商店里安装随包精选皮肤、浏览 Shimeji 内容、打开原站下载页面，再导入 ZIP 或文件夹。
